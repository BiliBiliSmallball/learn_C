#ifndef __STC8A8K64S4A12_H_
#define __STC8A8K64S4A12_H_
...
//宏定义
#define		SetBits(reg,x)			( reg |= (x) )		//将reg中的x位置为高
#define		ClrBits(reg,x)			( reg &=~(x) )		//将reg中的x位置为低
#define   Bits_ALL						0xff							//所有位
	//分析
...
//中断向量
#define		INT0_VECTOR			0		//外部中断0中断
#define		TIMER0_VECTOR		1		//定时器0中断
#define		INT1_VECTOR			2		//外部中断1中断
#define		TIMER1_VECTOR		3		//定时器1中断
#define		UART1_VECTOR		4		//串口1中断
#define		ADC_VECTOR			5		//模数转换中断
#define		LVD_VECTOR			6		//低压检测中断
#define		PCA_VECTOR			7		//捕获中断
#define		UART2_VECTOR		8		//串口2中断
#define		SPI_VECTOR			9		//串行外设中断
#define		INT2_VECTOR			10	//外部中断2中断
#define		INT3_VECTOR			11	//外部中断3中断
#define		TIMER2_VECTOR		12	//定时器2中断
#define		INT4_VECTOR			16	//外部中断4中断
#define		UART3_VECTOR		17	//串口3中断
#define		UART4_VECTOR		18	//串口4中断
#define		TIMER3_VECTOR		19	//定时器3中断
#define		TIMER4_VECTOR		20	//定时器4中断
#define		CMP_VECTOR			21	//比较器中断
#define		PWM_VECTOR			22	//PWM中断
#define		PWMFD_VECTOR		23	//PWM异常检测中断
#define		I2C_VECTOR			24	//I2C中断
...
sfr BUS_SPEED   =   0xa1;
sfr P_SW1       =   0xa2;
#define S1_S_1   		0x80	//串口1功能脚选择1
#define S1_S_0   		0x40	//串口1功能脚选择0
#define CCP_S_1   	0x20	//PCA功能脚选择1
#define CCP_S_0   	0x10	//PCA功能脚选择0
#define SPI_S_1   	0x08	//SPI功能脚选择1
#define SPI_S_0   	0x04	//SPI功能脚选择0
sfr P_SW2       =   0xba;
#define EAXFR       0x80	
#define I2C_S_1   	0x20	//I2C功能脚选择1
#define I2C_S_0   	0x10	//I2C功能脚选择0
#define CMPO_S   		0x08	//比较器输出脚选择
#define S4_S   			0x04	//串口4功能脚选择
#define S3_S   			0x02	//串口3功能脚选择
#define S2_S   			0x01	//串口2功能脚选择

sfr VOCTRL      =   0xbb;
sfr RSTCFG      =   0xff;
#define ENLVR       0x40		//低压复位控制
#define P54RST      0x10		//RST脚功能选择

//如下特殊功能寄存器位于扩展RAM区域
//访问这些寄存器,需先将P_SW2的BIT7设置为1,才可正常读写
#define CKSEL       (*(unsigned char volatile xdata *)0xfe00)
#define MCKODIV_3   0x80	//主时钟输出分频3
#define MCKODIV_2   0x40	//主时钟输出分频2
#define MCKODIV_1   0x20	//主时钟输出分频1
#define MCKODIV_0   0x10	//主时钟输出分频0
#define MCLKO_S    	0x08	//主时钟输出管脚选择
#define MCKSEL_1    0x02	//主时钟源选择1
#define MCKSEL_0    0x01	//主时钟源选择0
#define CLKDIV      (*(unsigned char volatile xdata *)0xfe01)
#define IRC24MCR    (*(unsigned char volatile xdata *)0xfe02)
#define ENIRC24M    0x80	//内部24M IRC使能
#define IRC24MST    0x01	//内部24M IRC稳定标记
#define XOSCCR      (*(unsigned char volatile xdata *)0xfe03)
#define ENXOSC    	0x80	//外部晶体振荡器使能
#define XITYPE    	0x40	//外部时钟类型
#define OSCST    		0x01	//外部晶体振荡器稳定标记
#define IRC32KCR    (*(unsigned char volatile xdata *)0xfe04)
#define ENIRC32K    0x80	//内部32K低速IRC使能
#define IRC32KST    0x01	//内部32K低速IRC稳定
...
#define CLR_WDT     0x10
#define IDL_WDT     0x08
#define WDT_PS_2    0x04	//看门狗定时器分频系数2
#define WDT_PS_1    0x02	//看门狗定时器分频系数1
#define WDT_PS_0    0x01	//看门狗定时器分频系数0
...
#define ADC_CHS_3   0x08	//ADC通道选择3
#define ADC_CHS_2   0x04	//ADC通道选择2
#define ADC_CHS_1   0x02	//ADC通道选择1
#define ADC_CHS_0   0x01	//ADC通道选择0
sfr ADC_RES     =   0xbd;
sfr ADC_RESL    =   0xbe;
sfr ADCCFG      =   0xde;
...
sbit CCF0       =   CCON^0;
sfr CMOD        =   0xd9;
#define CIDL        0x80	//PCA空闲模式是否计数
#define CPS_2   		0x08	//PCA时钟源选择2
#define CPS_1   		0x04	//PCA时钟源选择1
#define CPS_0   		0x02	//PCA时钟源选择0
#define ECF         0x01	//PCA计数溢出中断允许
sfr CL          =   0xe9;
sfr CH          =   0xf9;
sfr CCAPM0      =   0xda;
#define ECOM0       0x40
...
#define CCAPP3      0x20	//允许PCA模块3的上升沿捕获
#define CCAPN3      0x10	//允许PCA模块3的下降沿捕获
...
#define FDIF        0x01
sfr PWMCR       =   0xfe;
#define ENPWM       0x80	//使能PWM计数器
#define ECBI        0x40	//PWM计数器归零中断
...
#define ENC6O      	0x80	//PWM输出使能
#define C6INI      	0x40	//PWM输出端口初始电平
#define C6_S_1      0x10	//PWM输出功能脚切换1
#define C6_S_0     	0x08	//PWM输出功能脚切换0
...
#define ENI2C       0x80
#define MSSL        0x40
#define MSSPEED_6   0x20
#define MSSPEED_5   0x10
#define MSSPEED_4   0x08
#define MSSPEED_3   0x04
#define MSSPEED_2   0x02
#define MSSPEED_1   0x01
